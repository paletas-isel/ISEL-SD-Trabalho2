...
namespace ChatServiceProject.Translator {
    ...
    public partial class GetTranslationsResponse : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
        ...
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private ChatServiceProject.Translator.TranslationMatch[] TranslationsField;
        ...
        [System.Runtime.Serialization.DataMemberAttribute(EmitDefaultValue=false)]
        public ChatServiceProject.Translator.TranslationMatch[] Translations {
            get {
    ...
    public interface LanguageService {
        ...
        ChatServiceProject.Translator.GetTranslationsResponse GetTranslations(string appId, string text, string from, string to, int maxTranslations, ChatServiceProject.Translator.TranslateOptions options);
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://api.microsofttranslator.com/V2/LanguageService/AddTranslationArray", ReplyAction="http://api.microsofttranslator.com/V2/LanguageService/AddTranslationArrayResponse" +
            "")]
        void AddTranslationArray(string appId, ChatServiceProject.Translator.Translation[] translations, string from, string to, ChatServiceProject.Translator.TranslateOptions options);
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://api.microsofttranslator.com/V2/LanguageService/GetTranslationsArray", ReplyAction="http://api.microsofttranslator.com/V2/LanguageService/GetTranslationsArrayRespons" +
            "e")]
        ChatServiceProject.Translator.GetTranslationsResponse[] GetTranslationsArray(string appId, string[] texts, string from, string to, int maxTranslations, ChatServiceProject.Translator.TranslateOptions options);
        ...
        ChatServiceProject.Translator.TranslateArrayResponse[] TranslateArray(string appId, string[] texts, string from, string to, ChatServiceProject.Translator.TranslateOptions options);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface LanguageServiceChannel : ChatServiceProject.Translator.LanguageService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class LanguageServiceClient : System.ServiceModel.ClientBase<ChatServiceProject.Translator.LanguageService>, ChatServiceProject.Translator.LanguageService {
        ...
        public ChatServiceProject.Translator.GetTranslationsResponse GetTranslations(string appId, string text, string from, string to, int maxTranslations, ChatServiceProject.Translator.TranslateOptions options) {
        ...
        public void AddTranslationArray(string appId, ChatServiceProject.Translator.Translation[] translations, string from, string to, ChatServiceProject.Translator.TranslateOptions options) {
            base.Channel.AddTranslationArray(appId, translations, from, to, options);
        }
        
        public ChatServiceProject.Translator.GetTranslationsResponse[] GetTranslationsArray(string appId, string[] texts, string from, string to, int maxTranslations, ChatServiceProject.Translator.TranslateOptions options) {
        ...
        public ChatServiceProject.Translator.TranslateArrayResponse[] TranslateArray(string appId, string[] texts, string from, string to, ChatServiceProject.Translator.TranslateOptions options) {
